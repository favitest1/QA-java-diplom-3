...
public class UserOperations {
     ...
     */
    @Step ("Регистрация нового пользователя (post)")
     ...
     */
    @Step ("Удаление пользователя по токену (delete)")
    public void delete() {
    ...
    public void getUserAccessToken(Map<String, String> user, String endpoint) {
